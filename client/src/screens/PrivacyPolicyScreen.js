...
export default class App extends Component {
  ...
  render() {
    ...
    <p>UTMEats ("us", "we", or "our") operates the UTMEats mobile application (the "Service").</p>
    ...
    <p>UTMEats uses the collected data for various purposes:</p>    
    <ul>
    ...
    <p>UTMEats will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    
    <h2>Disclosure Of Data</h2>
    
    <h3>Legal Requirements</h3>
    <p>UTMEats may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of UTMEats</li>
    ...
    <ul>
            <li>By email: utmeats@gmail.com</li>
